<?php
  ...
  if(!empty($_POST))
  {
    $valor = $_POST['campo'];
    if(!empty($valor)){
      $where = "WHERE p.id LIKE '%$valor%'";
    }
  }
  $sql = "SELECT p.nombre as 'nombre_profesor', d.nombre as 'deporte_nombre', a.nombre, a.a_paterno, a.telefono as 'alumno_telefono', a.correo FROM alumno a INNER JOIN alumno_deporte ad ON a.cuenta = ad.cuenta_alumno INNER JOIN deporte d ON ad.id_deporte = d.id INNER JOIN profesor p ON d.id_profesor = p.id $where";
...
<script type="application/ld+json">{
  ...
  <body>
    ...
    <h2 class="txt-1"> <center>GRUPOS POR PROFESOR</center></h2>
      ...
      <A HREF="../login/MenuAdministrador.php"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-arrow-left-circle-fill" viewBox="0 0 16 16">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo $row['alumno_telefono'] ?></td>
